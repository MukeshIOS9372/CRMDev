...
struct ServiceAddressListsView: View {
    
//    var verticleLists = [CommonVerticleListModel]()
    @StateObject private var viewModel = ServiceAddressViewModel()
...
struct ServiceAddressList_ContentView_Previews: PreviewProvider {
