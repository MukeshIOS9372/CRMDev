...
struct WOTabsComponent: View {
    ...
    var body: some View {
        VStack(alignment: .center) {
            ...
            let verticleList = [CommonVerticleListModel(id: "ii", itemName: "WO-00000212", title: "Ceiling Fan Recoiling Work", address: "123 Main Street, Texas 451245",schedule: Client(name: "Schedule: ", info: "Nov. 4th, 2023 @12:45 PM"), horizontalMembers: [HorizontalMembersView(title: "Delegated To : ", membersArr: assignedMembersArr)], status: "Overdue", statusColor: "#E74C3C", amount: "$300.00", timeAgo: "3 Months ago", profitabilityArr: profitabilityArr)]
